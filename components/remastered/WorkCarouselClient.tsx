  ...
  return (
    <section className="bg-white py-24 lg:py-32 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 flex items-end justify-between mb-12">
        <div>
          <p className="text-[20px] font-semibold tracking-[0.3em] uppercase text-brand mb-4">Our Work</p>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center transition-opacity duration-300 group-hover:opacity-0">
                ...
                {p.location && (
                  <p className="mt-2 text-white/85 text-[20px] md:text-[20px] font-[300] tracking-[0.18em] uppercase [text-shadow:0_1px_8px_rgba(0,0,0,0.45)]">
                    {p.location}
                  </p>
                )}
              </div>
